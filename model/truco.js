		...
		component.root
		  .add(extensible.create_horizontal('main')
		    .add(component.main_left.set_priority(0)
		      ...
		      .add(extensible.create_horizontal('mentira2').set_priority(1)
		        .add(extensible.create_leaf('FaltaEnvido').set_priority(0))
		      )
		      .add(extensible.create_horizontal('rabon').set_priority(2)
		        .add(extensible.create_leaf('IrAlMazo').set_priority(0))
		        .add(extensible.create_leaf('Truco').set_priority(1))
		      )
		      .add(extensible.create_horizontal('rabon-bottom').set_priority(3)
		        .add(extensible.create_leaf('reTruco').set_priority(2))
		        .add(extensible.create_leaf('vale4').set_priority(3))
		      )
		      .add(extensible.create_horizontal('respuesta').set_priority(4)
		        .add(extensible.create_leaf('Quiero').set_priority(0))
		        .add(extensible.create_leaf('NoQuiero').set_priority(1))
		      )
		      .add(extensible.create_horizontal('reiniciar2').set_priority(5)
		        .add(extensible.create_leaf('Reiniciar-left').set_priority(0))
		      )
